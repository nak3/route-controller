...
import (
	...
	fake "github.com/nak3/gateway-api/pkg/client/gatewayapi/clientset/versioned/fake"
...
func Get(ctx context.Context) *fake.Clientset {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/nak3/gateway-api/pkg/client/gatewayapi/clientset/versioned/fake.Clientset from context.")
	}
