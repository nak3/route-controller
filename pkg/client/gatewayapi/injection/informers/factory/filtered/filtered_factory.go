...
import (
	...
	externalversions "github.com/nak3/gateway-api/pkg/client/gatewayapi/informers/externalversions"
	client "github.com/nak3/gateway-api/pkg/client/gatewayapi/injection/client"
...
func Get(ctx context.Context, selector string) externalversions.SharedInformerFactory {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch github.com/nak3/gateway-api/pkg/client/gatewayapi/informers/externalversions.SharedInformerFactory with selector %s from context.", selector)
	}
